            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-white">
                ...
                <div className="h-14 border-b border-neutral-200/60 px-6 flex items-center justify-between bg-neutral-50/50">
                  <div className="flex bg-white/60 border border-neutral-200/60 p-0.5 h-9 rounded-md shadow-sm">
                    <button
                      onClick={() => setActiveView("preview")}
                      className={`px-4 py-1.5 text-sm font-medium rounded transition-all ${activeView === "preview" ? "bg-red-500 text-white shadow-sm" : "text-neutral-600 hover:text-neutral-900"}`}
                    >
                      Preview
                    </button>
                    <button
                      onClick={() => setActiveView("code")}
                      className={`px-4 py-1.5 text-sm font-medium rounded transition-all ${activeView === "code" ? "bg-red-500 text-white shadow-sm" : "text-neutral-600 hover:text-neutral-900"}`}
                    >
                      Code
                    </button>
                  </div>
